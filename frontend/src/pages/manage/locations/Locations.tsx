...
import { Add01Icon, Delete02Icon, PencilEdit02Icon, StoreLocation02Icon } from 'hugeicons-react';
...
import { getCount } from '../../../services/Locations';
        ...
        <DelayedSuspense fallback={<SkeletonLoader />} delay={1000}>
            <div className='flex items-center justify-between w-full p-8 animate__animated animate__fadeIn animate__faster'>
                <div className='flex flex-col'>
                    <h1 className='text-2xl font-bold dark:text-white'>{translations.locations}</h1>
                    <span className='text-sm text-gray-600 dark:text-slate-400'>{translations.manage_locations_info}</span>
                </div>
            ...
            {isModalOpen.add && (
                <Modal title={translations.add_location} onClose={() => toggleModal('add', false)}>
            ...
            {isModalOpen.edit && (
                <Modal title={translations.edit_location} onClose={() => toggleModal('edit', false)}>
            ...
            {isModalOpen.delete && (
                <Modal title={translations.delete_location_sure} onClose={() => toggleModal('delete', false)}>
