...
import { Add01Icon, BankIcon, Delete02Icon, PencilEdit02Icon } from 'hugeicons-react';
...
import { getCount } from '../../../services/Banks';
        ...
        <DelayedSuspense fallback={<SkeletonLoader />} delay={1000}>
            <div className='flex items-center justify-between w-full p-8 animate__animated animate__fadeIn animate__faster'>
                <div className='flex flex-col'>
                    <h1 className='text-2xl font-bold dark:text-white'>Bancos</h1>
                    <span className='text-sm text-gray-600 dark:text-slate-400'>Administra bancos</span>
                </div>
            ...
            <div className='flex flex-col p-8 animate__animated animate__fadeIn animate__faster'>
                ...
                <div className='w-full mt-6'>
                    <Table endpoint='manage/banks' reloadTable={reloadTable} header={table_header} tbody={<TablePage selected={selected} setSelected={setSelected} />} />
                </div>
            </div>
            {isModalOpen.add && (
                <Modal title='Agregar banco' onClose={() => toggleModal('add', false)}>
            ...
            {isModalOpen.edit && (
                <Modal title='Editar banco' onClose={() => toggleModal('edit', false)}>
            ...
            {isModalOpen.delete && (
                <Modal title='Eliminar banco' onClose={() => toggleModal('delete', false)}>
