        ...
        <DelayedSuspense fallback={<SkeletonLoader />} delay={1000}>
            ...
            <div className='flex flex-col p-8 animate__animated animate__fadeIn animate__faster'>
                ...
                <div className='w-full mt-6'>
                    <Table endpoint='manage/typesids' reloadTable={reloadTable} header={table_header} tbody={<TablePage selected={selected} setSelected={setSelected} />} />
                </div>
            </div>
            {isModalOpen.add && (
                <Modal title={translations.add_identification} onClose={() => toggleModal('add', false)}>
            ...
            {isModalOpen.edit && (
                <Modal title={translations.edit_identification} onClose={() => toggleModal('edit', false)}>
            ...
            {isModalOpen.delete && (
                <Modal title={translations.delete_identification_sure} onClose={() => toggleModal('delete', false)}>
